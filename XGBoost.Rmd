...
if(params$subset_samples)
{
  ...
  species_occurrences_all = species_occurrences_all %>% filter(species %in% c("Aglais_caschmirensis", species_names[1:25]))
  rm(species_names)
}
```
...
Let's repeat this with improved parameters:
nrounds = 100
...
```{r loop, message=T, warning=FALSE, error=FALSE}
